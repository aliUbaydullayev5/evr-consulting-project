    ...
    return(
        <Container>
            ...
            <Container.ImgSection>
                <Image src={img5} alt={'img do not important'} className={'img1'} data-aos={widthWindow > 800 ? 'fade-left' : 'none'} />
                <Image src={img6} alt={'img do not important'} className={'img2'} data-aos={widthWindow > 800 ? 'fade-left' : 'none'} />
                <Image src={img7} alt={'img do not important'} className={'img3'} data-aos={widthWindow > 800 ? 'fade-right' : 'none'} />
            </Container.ImgSection>
